...
class_name BotonPlantaH
signal pedido_de_planta(llave_planta:String,llave_estructura,forma, emisor, ejemplar_planta)

@onready var boton: TextureButton = $HBoxContainer/Boton
@onready var imagen_etiqueta: NinePatchRect = $HBoxContainer/Boton/etiqueta_hover
@onready var etiqueta: Label = $HBoxContainer/Boton/etiqueta_hover/Label
